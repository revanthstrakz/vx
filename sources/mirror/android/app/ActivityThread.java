...
public class ActivityThread {
    ...
    /* renamed from: mH */
    public static RefObject<Handler> f212mH;
    ...
    /* renamed from: mirror.android.app.ActivityThread$H */
    public static class C1312H {
        ...
        public static Class<?> TYPE = RefClass.load(C1312H.class, "android.app.ActivityThread$H");
    }
    ...
    public static Object installProvider(Object obj, Context context, ProviderInfo providerInfo, Object obj2) {
        if (VERSION.SDK_INT <= 15) {
            return installProvider.call(obj, context, obj2, providerInfo, Boolean.valueOf(false), Boolean.valueOf(true));
        }
        return installProvider.call(obj, context, obj2, providerInfo, Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(true));
    }
}
