    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0041:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.C13371.run():void");
        }
    };
    boolean closed;
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C13401 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
