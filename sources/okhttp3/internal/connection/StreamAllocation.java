...
public final class StreamAllocation {
    ...
    private okhttp3.internal.connection.RealConnection findConnection(int r7, int r8, int r9, boolean r10) throws java.io.IOException {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r6.released     // Catch:{ all -> 0x00b5 }
            if (r1 != 0) goto L_0x00ad
            okhttp3.internal.http.HttpCodec r1 = r6.codec     // Catch:{ all -> 0x00b5 }
            if (r1 != 0) goto L_0x00a5
            boolean r1 = r6.canceled     // Catch:{ all -> 0x00b5 }
            if (r1 != 0) goto L_0x009d
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x00b5 }
            if (r1 == 0) goto L_0x0019
            boolean r2 = r1.noNewStreams     // Catch:{ all -> 0x00b5 }
            if (r2 != 0) goto L_0x0019
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
            return r1
        L_0x0019:
            okhttp3.internal.Internal r1 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x00b5 }
            okhttp3.ConnectionPool r2 = r6.connectionPool     // Catch:{ all -> 0x00b5 }
            okhttp3.Address r3 = r6.address     // Catch:{ all -> 0x00b5 }
            r4 = 0
            r1.get(r2, r3, r6, r4)     // Catch:{ all -> 0x00b5 }
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x00b5 }
            if (r1 == 0) goto L_0x002b
            okhttp3.internal.connection.RealConnection r7 = r6.connection     // Catch:{ all -> 0x00b5 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
            return r7
        L_0x002b:
            okhttp3.Route r1 = r6.route     // Catch:{ all -> 0x00b5 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
        ...
        L_0x0036:
            ...
            monitor-enter(r2)
            boolean r0 = r6.canceled     // Catch:{ all -> 0x009a }
            if (r0 != 0) goto L_0x0092
            okhttp3.internal.Internal r0 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x009a }
            okhttp3.ConnectionPool r3 = r6.connectionPool     // Catch:{ all -> 0x009a }
            okhttp3.Address r5 = r6.address     // Catch:{ all -> 0x009a }
            r0.get(r3, r5, r6, r1)     // Catch:{ all -> 0x009a }
            okhttp3.internal.connection.RealConnection r0 = r6.connection     // Catch:{ all -> 0x009a }
            if (r0 == 0) goto L_0x0050
            r6.route = r1     // Catch:{ all -> 0x009a }
            okhttp3.internal.connection.RealConnection r7 = r6.connection     // Catch:{ all -> 0x009a }
            monitor-exit(r2)     // Catch:{ all -> 0x009a }
            return r7
        L_0x0050:
            r6.route = r1     // Catch:{ all -> 0x009a }
            r0 = 0
            r6.refusedStreamCount = r0     // Catch:{ all -> 0x009a }
            okhttp3.internal.connection.RealConnection r0 = new okhttp3.internal.connection.RealConnection     // Catch:{ all -> 0x009a }
            okhttp3.ConnectionPool r3 = r6.connectionPool     // Catch:{ all -> 0x009a }
            r0.<init>(r3, r1)     // Catch:{ all -> 0x009a }
            r6.acquire(r0)     // Catch:{ all -> 0x009a }
            monitor-exit(r2)     // Catch:{ all -> 0x009a }
            r0.connect(r7, r8, r9, r10)
            ...
            monitor-enter(r7)
            okhttp3.internal.Internal r8 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x008f }
            okhttp3.ConnectionPool r9 = r6.connectionPool     // Catch:{ all -> 0x008f }
            r8.put(r9, r0)     // Catch:{ all -> 0x008f }
            boolean r8 = r0.isMultiplexed()     // Catch:{ all -> 0x008f }
            if (r8 == 0) goto L_0x008a
            okhttp3.internal.Internal r8 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x008f }
            okhttp3.ConnectionPool r9 = r6.connectionPool     // Catch:{ all -> 0x008f }
            okhttp3.Address r10 = r6.address     // Catch:{ all -> 0x008f }
            java.net.Socket r4 = r8.deduplicate(r9, r10, r6)     // Catch:{ all -> 0x008f }
            okhttp3.internal.connection.RealConnection r0 = r6.connection     // Catch:{ all -> 0x008f }
        L_0x008a:
        ...
        L_0x008f:
            ...
            throw r8
        L_0x0092:
            java.io.IOException r7 = new java.io.IOException     // Catch:{ all -> 0x009a }
        ...
        L_0x009a:
            ...
            throw r7
        L_0x009d:
            java.io.IOException r7 = new java.io.IOException     // Catch:{ all -> 0x00b5 }
            java.lang.String r8 = "Canceled"
