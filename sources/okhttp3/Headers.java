...
public final class Headers {
    ...
    public static final class Builder {
        ...
        public Builder addLenient(String str) {
            ...
            if (str.startsWith(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR)) {
    ...
    /* renamed from: of */
    public static Headers m108of(String... strArr) {
        if (strArr == null) {
    ...
    /* renamed from: of */
    public static Headers m107of(Map<String, String> map) {
        if (map != null) {
