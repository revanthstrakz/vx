...
class AdapterHelper implements Callback {
    ...
    public int applyPendingUpdatesToPosition(int r6) {
        ...
        L_0x0007:
            ...
            android.support.v7.widget.AdapterHelper$UpdateOp r2 = (android.support.p004v7.widget.AdapterHelper.UpdateOp) r2
            int r3 = r2.cmd
            r4 = 8
        ...
        L_0x004a:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.AdapterHelper.applyPendingUpdatesToPosition(int):int");
    }
