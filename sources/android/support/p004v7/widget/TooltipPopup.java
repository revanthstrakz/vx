...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0378R.layout.abc_tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0378R.C0381id.message);
        ...
        this.mLayoutParams.windowAnimations = C0378R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0378R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0378R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0378R.dimen.tooltip_y_offset_touch : C0378R.dimen.tooltip_y_offset_non_touch);
