...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0378R.C0380drawable.abc_popup_background_mtrl_mult, C0378R.C0380drawable.abc_cab_background_internal_bg, C0378R.C0380drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0378R.C0380drawable.abc_textfield_activated_mtrl_alpha, C0378R.C0380drawable.abc_textfield_search_activated_mtrl_alpha, C0378R.C0380drawable.abc_cab_background_top_mtrl_alpha, C0378R.C0380drawable.abc_text_cursor_material, C0378R.C0380drawable.abc_text_select_handle_left_mtrl_dark, C0378R.C0380drawable.abc_text_select_handle_middle_mtrl_dark, C0378R.C0380drawable.abc_text_select_handle_right_mtrl_dark, C0378R.C0380drawable.abc_text_select_handle_left_mtrl_light, C0378R.C0380drawable.abc_text_select_handle_middle_mtrl_light, C0378R.C0380drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0378R.C0380drawable.abc_textfield_search_default_mtrl_alpha, C0378R.C0380drawable.abc_textfield_default_mtrl_alpha, C0378R.C0380drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = {C0378R.C0380drawable.abc_btn_check_material, C0378R.C0380drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = {C0378R.C0380drawable.abc_ic_commit_search_api_mtrl_alpha, C0378R.C0380drawable.abc_seekbar_tick_mark_material, C0378R.C0380drawable.abc_ic_menu_share_mtrl_alpha, C0378R.C0380drawable.abc_ic_menu_copy_mtrl_am_alpha, C0378R.C0380drawable.abc_ic_menu_cut_mtrl_alpha, C0378R.C0380drawable.abc_ic_menu_selectall_mtrl_alpha, C0378R.C0380drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0378R.C0380drawable.abc_tab_indicator_material, C0378R.C0380drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (i == C0378R.C0380drawable.abc_cab_background_top_material) {
            cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0378R.C0380drawable.abc_cab_background_internal_bg), getDrawable(context, C0378R.C0380drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (cachedDrawable != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return wrap;
        } else if (i == C0378R.C0380drawable.abc_seekbar_track_material) {
            LayerDrawable layerDrawable = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (i == C0378R.C0380drawable.abc_ratingbar_material || i == C0378R.C0380drawable.abc_ratingbar_indicator_material || i == C0378R.C0380drawable.abc_ratingbar_small_material) {
            LayerDrawable layerDrawable2 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0378R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@android.support.annotation.NonNull android.content.Context r10, @android.support.annotation.DrawableRes int r11) {
        ...
        L_0x0077:
            ...
            android.support.v7.widget.AppCompatDrawableManager$InflateDelegate r2 = (android.support.p004v7.widget.AppCompatDrawableManager.InflateDelegate) r2     // Catch:{ Exception -> 0x00a8 }
    ...
    static boolean tintDrawableUsingColorFilter(@android.support.annotation.NonNull android.content.Context r6, @android.support.annotation.DrawableRes int r7, @android.support.annotation.NonNull android.graphics.drawable.Drawable r8) {
        /*
            ...
            int r2 = android.support.p004v7.appcompat.C0378R.attr.colorControlNormal
        L_0x0012:
            r7 = 1
            r1 = -1
            goto L_0x0044
        L_0x0015:
            ...
            int r2 = android.support.p004v7.appcompat.C0378R.attr.colorControlActivated
            goto L_0x0012
        L_0x0020:
            ...
            goto L_0x0012
        L_0x002b:
            int r1 = android.support.p004v7.appcompat.C0378R.C0380drawable.abc_list_divider_mtrl_alpha
            ...
            goto L_0x0044
        L_0x003c:
            int r1 = android.support.p004v7.appcompat.C0378R.C0380drawable.abc_dialog_material_background
        ...
        L_0x0044:
            ...
            boolean r7 = android.support.p004v7.widget.DrawableUtils.canSafelyMutateDrawable(r8)
            if (r7 == 0) goto L_0x0050
            android.graphics.drawable.Drawable r8 = r8.mutate()
        L_0x0050:
            int r6 = android.support.p004v7.widget.ThemeUtils.getThemeAttrColor(r6, r2)
    ...
    static Mode getTintMode(int i) {
        if (i == C0378R.C0380drawable.abc_switch_thumb_material) {
    ...
    public ColorStateList getTintList(@NonNull Context context, @DrawableRes int i) {
        ...
        if (tintListFromCache == null) {
            if (i == C0378R.C0380drawable.abc_edit_text_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_edittext);
            } else if (i == C0378R.C0380drawable.abc_switch_track_mtrl_alpha) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_switch_track);
            } else if (i == C0378R.C0380drawable.abc_switch_thumb_material) {
                tintListFromCache = createSwitchThumbColorStateList(context);
            } else if (i == C0378R.C0380drawable.abc_btn_default_mtrl_shape) {
                tintListFromCache = createDefaultButtonColorStateList(context);
            } else if (i == C0378R.C0380drawable.abc_btn_borderless_material) {
                tintListFromCache = createBorderlessButtonColorStateList(context);
            } else if (i == C0378R.C0380drawable.abc_btn_colored_material) {
                tintListFromCache = createColoredButtonColorStateList(context);
            } else if (i == C0378R.C0380drawable.abc_spinner_mtrl_am_alpha || i == C0378R.C0380drawable.abc_spinner_textfield_background_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, i)) {
                tintListFromCache = ThemeUtils.getThemeAttrColorStateList(context, C0378R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, i)) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, i)) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_btn_checkable);
            } else if (i == C0378R.C0380drawable.abc_seekbar_thumb_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0378R.color.abc_tint_seek_thumb);
            }
            if (tintListFromCache != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlHighlight);
        return new ColorStateList(new int[][]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.PRESSED_STATE_SET, ThemeUtils.FOCUSED_STATE_SET, ThemeUtils.EMPTY_STATE_SET}, new int[]{ThemeUtils.getDisabledThemeAttrColor(context, C0378R.attr.colorButtonNormal), ColorUtils.compositeColors(themeAttrColor, i), ColorUtils.compositeColors(themeAttrColor, i), i});
    }

    private ColorStateList createSwitchThumbColorStateList(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList themeAttrColorStateList = ThemeUtils.getThemeAttrColorStateList(context, C0378R.attr.colorSwitchThumbNormal);
        if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
            iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0378R.attr.colorSwitchThumbNormal);
            iArr[1] = ThemeUtils.CHECKED_STATE_SET;
            iArr2[1] = ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorControlActivated);
            iArr[2] = ThemeUtils.EMPTY_STATE_SET;
            iArr2[2] = ThemeUtils.getThemeAttrColor(context, C0378R.attr.colorSwitchThumbNormal);
        } else {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable drawable = getDrawable(context, C0378R.C0380drawable.abc_vector_test);
