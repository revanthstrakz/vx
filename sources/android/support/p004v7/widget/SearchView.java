...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0378R.attr.autoCompleteTextViewStyle);
        }
    ...
    private static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            L_0x006b:
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.SearchView.UpdatableTouchDelegate.onTouchEvent(android.view.MotionEvent):boolean");
        }
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0378R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0378R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0378R.styleable.SearchView_layout, C0378R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0378R.C0381id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0378R.C0381id.search_edit_frame);
        this.mSearchPlate = findViewById(C0378R.C0381id.search_plate);
        this.mSubmitArea = findViewById(C0378R.C0381id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0378R.C0381id.search_button);
        this.mGoButton = (ImageView) findViewById(C0378R.C0381id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0378R.C0381id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0378R.C0381id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0378R.C0381id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0378R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0378R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0378R.styleable.SearchView_suggestionRowLayout, C0378R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0378R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0378R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0378R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0378R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0378R.styleable.SearchView_queryHint);
        int i2 = obtainStyledAttributes.getInt(C0378R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0378R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0378R.styleable.SearchView_android_focusable, true));
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0378R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0378R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0378R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0378R.dimen.abc_dropdownitem_text_padding_left) : 0;
