...
class OpReorderer {
    ...
    public void swapMoveRemove(java.util.List<android.support.p004v7.widget.AdapterHelper.UpdateOp> r9, int r10, android.support.p004v7.widget.AdapterHelper.UpdateOp r11, int r12, android.support.p004v7.widget.AdapterHelper.UpdateOp r13) {
        /*
            r8 = this;
        ...
        L_0x011b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.OpReorderer.swapMoveRemove(java.util.List, int, android.support.v7.widget.AdapterHelper$UpdateOp, int, android.support.v7.widget.AdapterHelper$UpdateOp):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void swapMoveUpdate(java.util.List<android.support.p004v7.widget.AdapterHelper.UpdateOp> r8, int r9, android.support.p004v7.widget.AdapterHelper.UpdateOp r10, int r11, android.support.p004v7.widget.AdapterHelper.UpdateOp r12) {
        /*
            r7 = this;
        ...
        L_0x0073:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.OpReorderer.swapMoveUpdate(java.util.List, int, android.support.v7.widget.AdapterHelper$UpdateOp, int, android.support.v7.widget.AdapterHelper$UpdateOp):void");
    }
