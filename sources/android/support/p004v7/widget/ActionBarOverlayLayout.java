...
import p013io.virtualapp.widgets.CardStackAdapter;
...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0378R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = CardStackAdapter.ANIM_DURATION;
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0378R.C0381id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0378R.C0381id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0378R.C0381id.action_bar));
        }
    }
