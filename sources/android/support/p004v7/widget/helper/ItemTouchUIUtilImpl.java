...
class ItemTouchUIUtilImpl {
    ...
    static class Api21Impl extends BaseImpl {
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, View view, float f, float f2, int i, boolean z) {
            if (z && view.getTag(C0388R.C0390id.item_touch_helper_previous_elevation) == null) {
                Float valueOf = Float.valueOf(ViewCompat.getElevation(view));
                ViewCompat.setElevation(view, findMaxElevation(recyclerView, view) + 1.0f);
                view.setTag(C0388R.C0390id.item_touch_helper_previous_elevation, valueOf);
            }
        ...
        public void clearView(View view) {
            Object tag = view.getTag(C0388R.C0390id.item_touch_helper_previous_elevation);
            if (tag != null && (tag instanceof Float)) {
                ViewCompat.setElevation(view, ((Float) tag).floatValue());
            }
            view.setTag(C0388R.C0390id.item_touch_helper_previous_elevation, null);
