...
import android.support.p004v7.widget.RecyclerView.ChildDrawingOrderCallback;
...
import android.support.p004v7.widget.RecyclerView.OnChildAttachStateChangeListener;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper.this.mInitialTouchX -= findAnimation.f41mX;
                        ItemTouchHelper.this.mInitialTouchY -= findAnimation.f42mY;
    ...
    public static abstract class Callback {
        ...
        public android.support.p004v7.widget.RecyclerView.ViewHolder chooseDropTarget(android.support.p004v7.widget.RecyclerView.ViewHolder r15, java.util.List<android.support.p004v7.widget.RecyclerView.ViewHolder> r16, int r17, int r18) {
            /*
                r14 = this;
                r0 = r15
            ...
            L_0x0028:
                ...
                android.support.v7.widget.RecyclerView$ViewHolder r10 = (android.support.p004v7.widget.RecyclerView.ViewHolder) r10
            ...
            L_0x00be:
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.helper.ItemTouchHelper.Callback.chooseDropTarget(android.support.v7.widget.RecyclerView$ViewHolder, java.util.List, int, int):android.support.v7.widget.RecyclerView$ViewHolder");
        }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0388R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f41mX, recoverAnimation.f42mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f41mX, recoverAnimation.f42mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            if (this.mStartDx == this.mTargetX) {
                ...
                this.f41mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.f42mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f42mY = this.mStartDy + (this.mFraction * (this.mTargetY - this.mStartDy));
            }
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0388R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0388R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void select(android.support.p004v7.widget.RecyclerView.ViewHolder r24, int r25) {
        /*
            r23 = this;
            r11 = r23
            r12 = r24
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f41mX, recoverAnimation.f42mY)) {
                return view2;
            }
        }
