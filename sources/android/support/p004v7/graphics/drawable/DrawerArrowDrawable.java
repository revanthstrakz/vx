...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, C0378R.styleable.DrawerArrowToggle, C0378R.attr.drawerArrowStyle, C0378R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(obtainStyledAttributes.getColor(C0378R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(obtainStyledAttributes.getDimension(C0378R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(obtainStyledAttributes.getBoolean(C0378R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(obtainStyledAttributes.getDimension(C0378R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(C0378R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(obtainStyledAttributes.getDimension(C0378R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(obtainStyledAttributes.getDimension(C0378R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = obtainStyledAttributes.getDimension(C0378R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0016, code lost:
        if (android.support.p001v4.graphics.drawable.DrawableCompat.getLayoutDirection(r19) == 1) goto L_0x0018;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x001e, code lost:
        if (android.support.p001v4.graphics.drawable.DrawableCompat.getLayoutDirection(r19) == 0) goto L_0x0018;
     */
    ...
    public void draw(android.graphics.Canvas r20) {
        ...
        L_0x0012:
            int r3 = android.support.p001v4.graphics.drawable.DrawableCompat.getLayoutDirection(r19)
        ...
        L_0x0115:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.graphics.drawable.DrawerArrowDrawable.draw(android.graphics.Canvas):void");
    }
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo446to = 1.0d) float f) {
        if (this.mProgress != f) {
            this.mProgress = f;
            invalidateSelf();
        }
