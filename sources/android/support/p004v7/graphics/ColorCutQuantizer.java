...
import android.support.p004v7.graphics.Palette.Filter;
...
final class ColorCutQuantizer {
    ...
    static void modifySignificantOctet(int[] r2, int r3, int r4, int r5) {
        ...
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.graphics.ColorCutQuantizer.modifySignificantOctet(int[], int, int, int):void");
    }
