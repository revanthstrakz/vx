...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new Comparator<Snake>() {
        public int compare(Snake snake, Snake snake2) {
            int i = snake.f35x - snake2.f35x;
            return i == 0 ? snake.f36y - snake2.f36y : i;
        }
    };
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f35x != 0 || snake.f36y != 0) {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f35x + snake.size;
                int i4 = snake.f36y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f35x + i5;
                    int i7 = snake.f36y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f35x + snake.size;
                int i7 = snake.f36y + snake.size;
                int i8 = 4;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = (Snake) this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f35x + i3;
                int i5 = snake.f36y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f35x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f35x + i6, 1, this.mCallback.getChangePayload(snake.f35x + i6, snake.f36y + i6));
                    }
                }
                i = snake.f35x;
                i2 = snake.f36y;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f35x += range.oldListStart;
                diffPartial.f36y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f35x;
                    range2.newListEnd = diffPartial.f36y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f35x - 1;
                    range2.newListEnd = diffPartial.f36y;
                } else {
                    range2.oldListEnd = diffPartial.f35x;
                    range2.newListEnd = diffPartial.f36y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f35x + diffPartial.size;
                    range.newListStart = diffPartial.f36y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f35x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f36y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f35x + diffPartial.size;
                    range.newListStart = diffPartial.f36y + diffPartial.size + 1;
                }
    ...
    private static android.support.p004v7.util.DiffUtil.Snake diffPartial(android.support.p004v7.util.DiffUtil.Callback r21, int r22, int r23, int r24, int r25, int[] r26, int[] r27, int r28) {
        /*
            r0 = r21
            r3 = r26
            r4 = r27
