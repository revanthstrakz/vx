...
import android.support.p004v7.util.ThreadUtil.BackgroundCallback;
import android.support.p004v7.util.ThreadUtil.MainThreadCallback;
import android.support.p004v7.util.TileList.Tile;
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> mainThreadCallback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new Runnable() {
                public void run() {
                    SyncQueueItem next = C03981.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> backgroundCallback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new Runnable() {
                public void run() {
                    while (true) {
                        SyncQueueItem next = C04002.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C04002.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C04002.this.mQueue.removeMessages(2);
                                    C04002.this.mQueue.removeMessages(3);
                            ...
                            C04002.this.mBackgroundRunning.set(false);
                            return;
                        }
                    }
                }
