...
import android.support.p004v7.app.ActionBar.LayoutParams;
...
import android.support.p004v7.app.ActionBar.Tab;
import android.support.p004v7.app.ActionBar.TabListener;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0378R.C0381id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0378R.C0381id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0378R.C0381id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0378R.C0381id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0378R.styleable.ActionBar, C0378R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0378R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0378R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0378R.attr.actionBarWidgetTheme, typedValue, true);
