...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f30C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f31C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f32C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f33J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double d4 = (-d2) / 360.0d;
        double round = ((double) (((float) Math.round(((double) (f - f33J0)) - d4)) + f33J0)) + d4 + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * sin) * -0.0069d);
