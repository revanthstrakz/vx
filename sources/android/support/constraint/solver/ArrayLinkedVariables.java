...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        if (f == 0.0f) {
            ...
            this.mArrayIndices[this.mHead] = solverVariable.f8id;
            ...
            this.mArrayIndices[i4] = solverVariable.f8id;
    ...
    public final void add(SolverVariable solverVariable, float f) {
        if (f != 0.0f) {
            ...
            this.mArrayIndices[i5] = solverVariable.f8id;
    ...
    public void updateFromRow(ArrayRow arrayRow, ArrayRow arrayRow2) {
        ...
        while (true) {
            int i2 = 0;
            while (i != -1 && i2 < this.currentSize) {
                if (this.mArrayIndices[i] == arrayRow2.variable.f8id) {
