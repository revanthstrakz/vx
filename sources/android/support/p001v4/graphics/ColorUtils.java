...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo452to = 255) int i, @IntRange(from = 0, mo452to = 255) int i2, @IntRange(from = 0, mo452to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float f2;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, mo452to = 255) int i2) {
        if (i2 >= 0 && i2 <= 255) {
    ...
    public static void RGBToLAB(@IntRange(from = 0, mo452to = 255) int i, @IntRange(from = 0, mo452to = 255) int i2, @IntRange(from = 0, mo452to = 255) int i3, @NonNull double[] dArr) {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, mo452to = 255) int i, @IntRange(from = 0, mo452to = 255) int i2, @IntRange(from = 0, mo452to = 255) int i3, @NonNull double[] dArr) {
        double pow;
        double pow2;
        double d;
        double[] dArr2 = dArr;
        if (dArr2.length == 3) {
            ...
            dArr2[2] = ((d3 * 0.0193d) + (d5 * 0.1192d) + (d * 0.9505d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
        throw new IllegalArgumentException("outXyz must have a length of 3.");
    }

    public static void XYZToLAB(@FloatRange(from = 0.0d, mo446to = 95.047d) double d, @FloatRange(from = 0.0d, mo446to = 100.0d) double d2, @FloatRange(from = 0.0d, mo446to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, mo446to = 100.0d) double d, @FloatRange(from = -128.0d, mo446to = 127.0d) double d2, @FloatRange(from = -128.0d, mo446to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, mo446to = 95.047d) double d, @FloatRange(from = 0.0d, mo446to = 100.0d) double d2, @FloatRange(from = 0.0d, mo446to = 108.883d) double d3) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, mo446to = 100.0d) double d, @FloatRange(from = -128.0d, mo446to = 127.0d) double d2, @FloatRange(from = -128.0d, mo446to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, mo446to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((((float) Color.alpha(i)) * f2) + (((float) Color.alpha(i2)) * f)), (int) ((((float) Color.red(i)) * f2) + (((float) Color.red(i2)) * f)), (int) ((((float) Color.green(i)) * f2) + (((float) Color.green(i2)) * f)), (int) ((((float) Color.blue(i)) * f2) + (((float) Color.blue(i2)) * f)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, mo446to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length == 3) {
            float f2 = 1.0f - f;
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, mo446to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length == 3) {
            double d2 = 1.0d - d;
