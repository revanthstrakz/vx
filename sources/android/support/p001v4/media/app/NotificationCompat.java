...
import android.support.mediacompat.C0128R;
...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0128R.layout.notification_template_media_custom;
            }
        ...
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0128R.layout.notification_template_big_media_narrow_custom : C0128R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0128R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0128R.C0130id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0128R.C0130id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0128R.C0130id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0128R.C0130id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0128R.C0130id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0128R.C0130id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0128R.C0130id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0128R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0128R.C0130id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0128R.C0130id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0128R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0128R.C0130id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0128R.C0130id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0128R.C0130id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int getContentViewLayoutResource() {
            return C0128R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0128R.C0130id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0128R.C0130id.cancel_action, 0);
        ...
        /* access modifiers changed from: 0000 */
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0128R.layout.notification_template_big_media_narrow : C0128R.layout.notification_template_big_media;
        }
    }
