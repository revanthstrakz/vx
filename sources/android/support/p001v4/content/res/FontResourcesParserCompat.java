...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0035R.styleable.FontFamily);
        String string = obtainAttributes.getString(C0035R.styleable.FontFamily_fontProviderAuthority);
        String string2 = obtainAttributes.getString(C0035R.styleable.FontFamily_fontProviderPackage);
        String string3 = obtainAttributes.getString(C0035R.styleable.FontFamily_fontProviderQuery);
        int resourceId = obtainAttributes.getResourceId(C0035R.styleable.FontFamily_fontProviderCerts, 0);
        int integer = obtainAttributes.getInteger(C0035R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int integer2 = obtainAttributes.getInteger(C0035R.styleable.FontFamily_fontProviderFetchTimeout, 500);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0035R.styleable.FontFamilyFont);
        int i = obtainAttributes.getInt(obtainAttributes.hasValue(C0035R.styleable.FontFamilyFont_fontWeight) ? C0035R.styleable.FontFamilyFont_fontWeight : C0035R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
        if (1 != obtainAttributes.getInt(obtainAttributes.hasValue(C0035R.styleable.FontFamilyFont_fontStyle) ? C0035R.styleable.FontFamilyFont_fontStyle : C0035R.styleable.FontFamilyFont_android_fontStyle, 0)) {
            z = false;
        }
        int i2 = obtainAttributes.hasValue(C0035R.styleable.FontFamilyFont_font) ? C0035R.styleable.FontFamilyFont_font : C0035R.styleable.FontFamilyFont_android_font;
