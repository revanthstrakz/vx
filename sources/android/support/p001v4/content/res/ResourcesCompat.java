...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r14, android.content.res.Resources r15, android.util.TypedValue r16, int r17, int r18, @android.support.annotation.Nullable android.support.p001v4.content.res.ResourcesCompat.FontCallback r19, @android.support.annotation.Nullable android.os.Handler r20, boolean r21) {
        ...
        L_0x0024:
            return r12
        L_0x0025:
            android.graphics.Typeface r1 = android.support.p001v4.graphics.TypefaceCompat.findFromCache(r15, r4, r5)
        ...
        L_0x0031:
            ...
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.p001v4.content.res.FontResourcesParserCompat.parse(r1, r15)     // Catch:{ XmlPullParserException -> 0x008e, IOException -> 0x0076 }
        ...
        L_0x0054:
            ...
            r7 = r20
            r8 = r21
            android.graphics.Typeface r0 = android.support.p001v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x008e, IOException -> 0x0076 }
            return r0
        L_0x0065:
            r1 = r14
            android.graphics.Typeface r0 = android.support.p001v4.graphics.TypefaceCompat.createFromResourcesFontFile(r14, r15, r4, r11, r5)     // Catch:{ XmlPullParserException -> 0x008e, IOException -> 0x0076 }
