...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@android.support.annotation.NonNull android.content.Intent r22) {
        /*
            ...
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x016c }
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x016c }
        ...
        L_0x0080:
            ...
            r5 = r3
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r5 = (android.support.p001v4.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x016c }
            ...
            android.content.IntentFilter r9 = r5.filter     // Catch:{ all -> 0x016c }
            r4.append(r9)     // Catch:{ all -> 0x016c }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x016c }
        L_0x00a7:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x016c }
        ...
        L_0x00b4:
            ...
            goto L_0x012e
        L_0x00c0:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x016c }
        ...
        L_0x013e:
            ...
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r4 = (android.support.p001v4.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x016c }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x016c }
            int r3 = r3 + 1
            goto L_0x013e
        L_0x0150:
            java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x016c }
            android.support.v4.content.LocalBroadcastManager$BroadcastRecord r4 = new android.support.v4.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x016c }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x016c }
            r3.add(r4)     // Catch:{ all -> 0x016c }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x016c }
