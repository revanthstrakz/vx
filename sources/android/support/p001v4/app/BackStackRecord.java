...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    String mName;
    ArrayList<C0188Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0188Op {
        ...
        C0188Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                C0188Op op = (C0188Op) this.mOps.get(i);
                switch (op.cmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0188Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0188Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0188Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0188Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0188Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0188Op(8, fragment));
        return this;
    }
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0188Op op = (C0188Op) this.mOps.get(i2);
                if (op.fragment != null) {
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0188Op op = (C0188Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0188Op op2 = (C0188Op) backStackRecord.mOps.get(i7);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0188Op op = (C0188Op) this.mOps.get(size);
            Fragment fragment = op.fragment;
            if (fragment != null) {
            ...
            switch (op.cmd) {
                        ...
                        if (fragment5.mContainerId == i2) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i3, new C0188Op(9, fragment5));
                                    i3++;
                                    fragment4 = null;
                                }
                                C0188Op op2 = new C0188Op(3, fragment5);
                ...
                case 6:
                    ...
                    if (op.fragment != fragment2) {
                        ...
                        this.mOps.add(i, new C0188Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                        break;
                    }
                case 8:
                    this.mOps.add(i, new C0188Op(9, fragment2));
                    i++;
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0188Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0188Op op) {
        Fragment fragment = op.fragment;
