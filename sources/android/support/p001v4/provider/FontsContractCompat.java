...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo452to = 1000) int i2, boolean z, int i3) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008c, code lost:
        sBackgroundThread.postAndReply(r1, new android.support.p001v4.provider.FontsContractCompat.C02943());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final android.support.p001v4.provider.FontRequest r3, @android.support.annotation.Nullable final android.support.p001v4.content.res.ResourcesCompat.FontCallback r4, @android.support.annotation.Nullable final android.os.Handler r5, boolean r6, int r7, final int r8) {
        /*
        ...
        L_0x0045:
            ...
            android.support.v4.provider.FontsContractCompat$TypefaceResult r3 = (android.support.p001v4.provider.FontsContractCompat.TypefaceResult) r3     // Catch:{ InterruptedException -> 0x0058 }
