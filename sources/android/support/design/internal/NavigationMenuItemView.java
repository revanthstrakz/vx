...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTextView = (CheckedTextView) findViewById(C0052R.C0055id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0052R.C0055id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0378R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0052R.C0054drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
