...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_margin);
        ...
        setBackgroundResource(C0052R.C0054drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0052R.C0055id.icon);
        this.mSmallLabel = (TextView) findViewById(C0052R.C0055id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0052R.C0055id.largeLabel);
    }
