...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0052R.styleable.ForegroundLinearLayout, i, 0);
        this.mForegroundGravity = obtainStyledAttributes.getInt(C0052R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.mForegroundGravity);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0052R.styleable.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = obtainStyledAttributes.getBoolean(C0052R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
