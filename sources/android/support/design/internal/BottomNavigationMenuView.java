...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mInactiveItemMaxWidth = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = resources.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_height);
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i10], 1073741824), makeMeasureSpec);
                childAt.getLayoutParams().width = childAt.getMeasuredWidth();
                i9 += childAt.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i9, MeasureSpec.makeMeasureSpec(i9, 1073741824), 0), View.resolveSizeAndState(this.mItemHeight, makeMeasureSpec, 0));
    }
