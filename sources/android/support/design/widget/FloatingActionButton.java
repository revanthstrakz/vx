...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0052R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = obtainStyledAttributes.getBoolean(C0052R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0052R.styleable.FloatingActionButton, i, C0052R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = obtainStyledAttributes.getColorStateList(C0052R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0052R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = obtainStyledAttributes.getColor(C0052R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = obtainStyledAttributes.getInt(C0052R.styleable.FloatingActionButton_fabSize, -1);
        this.mCustomSize = obtainStyledAttributes.getDimensionPixelSize(C0052R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C0052R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = obtainStyledAttributes.getDimension(C0052R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = obtainStyledAttributes.getDimension(C0052R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = obtainStyledAttributes.getBoolean(C0052R.styleable.FloatingActionButton_useCompatPadding, false);
        obtainStyledAttributes.recycle();
    ...
    private int getSizeDimension(int i) {
        ...
        if (i == -1) {
            ...
            return resources.getDimensionPixelSize(C0052R.dimen.design_fab_size_normal);
        } else {
            return resources.getDimensionPixelSize(C0052R.dimen.design_fab_size_mini);
        }
    }
