...
class FloatingActionButtonImpl {
    ...
    public CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C0052R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0052R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0052R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0052R.color.design_fab_stroke_end_outer_color));
