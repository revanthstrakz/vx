...
import android.support.coreui.C0046R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0046R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0046R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0046R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0046R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0046R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0046R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0046R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0046R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0046R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0046R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            typedArray = context.obtainStyledAttributes(attributeSet, C0046R.styleable.CoordinatorLayout, 0, C0046R.style.Widget_Support_CoordinatorLayout);
        } else {
            typedArray = context.obtainStyledAttributes(attributeSet, C0046R.styleable.CoordinatorLayout, i, 0);
        }
        int resourceId = typedArray.getResourceId(C0046R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArray.getDrawable(C0046R.styleable.CoordinatorLayout_statusBarBackground);
        typedArray.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r31, int r32) {
        /*
            ...
            int r10 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r30)
            r2 = 1
        ...
        L_0x0022:
            ...
            boolean r3 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r30)
            if (r3 == 0) goto L_0x004b
            r19 = 1
            goto L_0x004d
        L_0x004b:
        ...
        L_0x0071:
            ...
            int r11 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r11, r10)
            r11 = r11 & 7
            r22 = r2
            r2 = 3
        ...
        L_0x00bf:
            ...
            boolean r0 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r20)
    ...
    private void offsetChildByInset(android.view.View r9, android.graphics.Rect r10, int r11) {
        /*
            r8 = this;
            boolean r0 = android.support.p001v4.view.ViewCompat.isLaidOut(r9)
        ...
        L_0x0080:
            ...
            int r11 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r1, r11)
            r1 = r11 & 48
            r3 = 48
            r4 = 1
            r5 = 0
