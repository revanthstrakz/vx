...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f2X = new ViewProperty("x") {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f3Y = new ViewProperty("y") {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f4Z = new ViewProperty("z") {
        public void setValue(View view, float f) {
