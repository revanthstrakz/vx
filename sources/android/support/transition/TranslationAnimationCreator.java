...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        private TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            this.mTerminalX = f;
            this.mTerminalY = f2;
            this.mTransitionPosition = (int[]) this.mViewInHierarchy.getTag(C0160R.C0162id.transition_position);
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0160R.C0162id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0160R.C0162id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0160R.C0162id.transition_position);
        if (iArr != null) {
