...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C01473 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.transition.ChangeImageTransform.C01473.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C01473.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
