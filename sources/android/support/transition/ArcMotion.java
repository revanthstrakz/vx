...
public class ArcMotion extends PathMotion {
    ...
    public Path getPath(float f, float f2, float f3, float f4) {
        ...
        if (Math.abs(f10) < Math.abs(f11)) {
            ...
            f5 = this.mMinimumVerticalTangent * f15 * this.mMinimumVerticalTangent;
        } else {
            ...
            f5 = this.mMinimumHorizontalTangent * f15 * this.mMinimumHorizontalTangent;
        }
        float f17 = f13 - f7;
        float f18 = f14 - f6;
        float f19 = (f17 * f17) + (f18 * f18);
        float f20 = f15 * this.mMaximumTangent * this.mMaximumTangent;
        if (f19 >= f5) {
            f5 = f19 > f20 ? f20 : 0.0f;
        }
        if (f5 != 0.0f) {
            float sqrt = (float) Math.sqrt((double) (f5 / f19));
            f7 = ((f7 - f13) * sqrt) + f13;
            f6 = f14 + (sqrt * (f6 - f14));
        }
