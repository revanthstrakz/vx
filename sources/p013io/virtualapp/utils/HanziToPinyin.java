...
/* renamed from: io.virtualapp.utils.HanziToPinyin */
public class HanziToPinyin {
    ...
    /* renamed from: io.virtualapp.utils.HanziToPinyin$Token */
        ...
        synchronized (HanziToPinyin.class) {
            ...
            while (i < availableLocales.length) {
                if (!availableLocales[i].equals(Locale.CHINA)) {
                    if (!availableLocales[i].getLanguage().contains("zh")) {
                        i++;
                    }
                }
                sInstance = new HanziToPinyin(true);
                HanziToPinyin hanziToPinyin2 = sInstance;
                return hanziToPinyin2;
            }
            if (sInstance != null || !Locale.CHINA.equals(Locale.getDefault())) {
                Log.w(TAG, "There is no Chinese collator, HanziToPinyin is disabled");
                sInstance = new HanziToPinyin(false);
                HanziToPinyin hanziToPinyin3 = sInstance;
                return hanziToPinyin3;
            }
            sInstance = new HanziToPinyin(true);
            HanziToPinyin hanziToPinyin4 = sInstance;
            return hanziToPinyin4;
        }
    }
    ...
    private static boolean doSelfValidation() {
        ...
        for (char c2 : UNIHANS) {
            if (c != c2) {
                ...
                if (COLLATOR.compare(str, ch2) >= 0) {
                    String str2 = TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("Internal error in Unihan table. The last string \"");
                    sb.append(str);
                    sb.append("\" is greater than current string \"");
                    sb.append(ch2);
                    sb.append("\".");
