...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo446to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, mo452to = 100) int i) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, mo446to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions encodeQuality(@IntRange(from = 0, mo452to = 100) int i) {
