...
public final class Util {
    ...
    static /* synthetic */ class C09071 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C09071.<clinit>():void");
        }
    }
    ...
    private static String bytesToHex(@NonNull byte[] bArr, @NonNull char[] cArr) {
        for (int i = 0; i < bArr.length; i++) {
            byte b = bArr[i] & 255;
            int i2 = i * 2;
            cArr[i2] = HEX_CHAR_ARRAY[b >>> 4];
            cArr[i2 + 1] = HEX_CHAR_ARRAY[b & 15];
        }
    ...
    private static int getBytesPerPixel(@Nullable Config config) {
        ...
        switch (C09071.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 1;
            case 2:
            case 3:
