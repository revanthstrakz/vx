...
public class RequestManagerRetriever implements Callback {
    ...
    public RequestManager get(@NonNull View view) {
        ...
        if (findActivity instanceof FragmentActivity) {
            android.support.p001v4.app.Fragment findSupportFragment = findSupportFragment(view, (FragmentActivity) findActivity);
    ...
    private static void findAllSupportFragmentsWithViews(@Nullable Collection<android.support.p001v4.app.Fragment> collection, @NonNull Map<View, android.support.p001v4.app.Fragment> map) {
        if (collection != null) {
            for (android.support.p001v4.app.Fragment fragment : collection) {
    ...
    @Nullable
    private android.support.p001v4.app.Fragment findSupportFragment(@NonNull View view, @NonNull FragmentActivity fragmentActivity) {
        ...
        android.support.p001v4.app.Fragment fragment = null;
        while (!view.equals(findViewById)) {
            fragment = (android.support.p001v4.app.Fragment) this.tempViewToSupportFragment.get(view);
    ...
    @NonNull
    private SupportRequestManagerFragment getSupportRequestManagerFragment(@NonNull android.support.p001v4.app.FragmentManager fragmentManager, @Nullable android.support.p001v4.app.Fragment fragment, boolean z) {
        ...
        if (supportRequestManagerFragment == null) {
            ...
            if (supportRequestManagerFragment == null) {
                ...
                fragmentManager.beginTransaction().add((android.support.p001v4.app.Fragment) supportRequestManagerFragment, FRAGMENT_TAG).commitAllowingStateLoss();
    ...
    @NonNull
    private RequestManager supportFragmentGet(@NonNull Context context, @NonNull android.support.p001v4.app.FragmentManager fragmentManager, @Nullable android.support.p001v4.app.Fragment fragment, boolean z) {
