...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f86ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    ...
    public int hashCode() {
        return Util.hashCode(f86ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
