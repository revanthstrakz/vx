...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static /* synthetic */ class C08781 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C08781.<clinit>():void");
        }
    }
    ...
    private static Config[] getInConfigs(Config config) {
        ...
        switch (C08781.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
