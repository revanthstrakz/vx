...
class DataCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final FetcherReadyCallback f77cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f77cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f77cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(@NonNull Exception exc) {
        this.f77cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
