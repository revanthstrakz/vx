...
public interface IAppRequestListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppRequestListener {
        private static final String DESCRIPTOR = "com.lody.virtual.server.interfaces.IAppRequestListener";
        static final int TRANSACTION_onRequestInstall = 1;
        static final int TRANSACTION_onRequestUninstall = 2;

        private static class Proxy implements IAppRequestListener {
        ...
        public static IAppRequestListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IAppRequestListener)) {
                return new Proxy(iBinder);
            }
            return (IAppRequestListener) queryLocalInterface;
        }
