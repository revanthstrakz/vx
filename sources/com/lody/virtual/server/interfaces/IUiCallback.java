...
public interface IUiCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUiCallback {
        private static final String DESCRIPTOR = "com.lody.virtual.server.interfaces.IUiCallback";
        static final int TRANSACTION_onAppOpened = 1;
        static final int TRANSACTION_onOpenFailed = 2;

        private static class Proxy implements IUiCallback {
        ...
        public static IUiCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IUiCallback)) {
                return new Proxy(iBinder);
            }
            return (IUiCallback) queryLocalInterface;
        }
