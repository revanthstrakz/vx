...
public class DefaultHttpClient implements HttpClient, Tracker {
    ...
    public ServiceCall callAsync(String str, String str2, Map<String, String> map, CallTemplate callTemplate, final ServiceCallback serviceCallback) {
