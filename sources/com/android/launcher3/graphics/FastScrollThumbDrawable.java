...
public class FastScrollThumbDrawable extends Drawable {
    ...
    public void onBoundsChange(Rect rect) {
        ...
        this.mPath.addRoundRect((float) rect.left, (float) rect.top, ((float) rect.left) + f, ((float) rect.top) + f, new float[]{height, height, height, height, f2, f2, height, height}, Direction.CCW);
